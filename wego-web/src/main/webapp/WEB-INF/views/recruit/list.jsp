				...
				<div class="recruit">
					...
					<a href="/recruit/detail?sanPartyId=${item.sanPartyId}">
						<div class="recruit-item">
							...
							<p class="recruit-schedule" id="schedule"><fmt:formatDate value="${item.partyDate}" pattern="yyyy-MM-dd" /></p>
							<p class="recruit-schedule-time">시간:</p>
							<p class="recruit-time" id="time"><fmt:formatDate value="${item.partyDate}" pattern="HH:mm" /></p>
